...
import { getUsuarios } from "../../service/Usuarios_Service"; // Asegúrate de ajustar la ruta según tu estructura de archivos
import { Usuario } from "../../interface/UsuarioInterface"; // Asegúrate de ajustar la ruta según tu estructura de archivos
              ...
              <tbody>
                {empleados.map((empleado, index) => (
                  <tr key={index} className="hover:bg-gray-100">
                    ...
                    <td className="py-2 px-4 border-b">{empleado.ci}</td>
                    <td className="py-2 px-4 border-b">{empleado.telefono}</td>
                    <td className="py-2 px-4 border-b">{empleado.direccion}</td>
                    <td className="py-2 px-4 border-b">{empleado.correoelectronico}</td>
                  </tr>
                ))}
              </tbody>
            </table>
